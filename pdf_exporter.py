...
# Position du nom, age et point de vie.
perso_pos = {
    'metier': (125, 629),
    'nom': (151, 609),
    'age': (146, 595),
...
class PdfExporter():
    ...
    def __init__(self, personnage):
        ...
        self.perso_dico = personnage.get_full_dict()
    ...
    @staticmethod
    def define_name(dir):
        counter = PdfExporter.count_export(dir) + 1
        return f"export_{counter}.pdf"

    @staticmethod
    def count_export(dir):
        # Count number of export file.
        return len([f for f in listdir(dir) if 'export_' in f])
